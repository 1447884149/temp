...
# loss2去掉生成的节点，worker为fgpl_nocluster_worker，也没有聚类
...
def call_my_trainer(trainer_type):
    if trainer_type == 'fgpl_no_strengthnode_inloss2':
        trainer_builder = FedProto_Node_Trainer
        return trainer_builder


register_trainer('fgpl_no_strengthnode_inloss2', call_my_trainer)
